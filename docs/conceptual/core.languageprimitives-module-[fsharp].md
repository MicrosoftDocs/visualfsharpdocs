...
|[GenericComparisonWithComparer](https://msdn.microsoft.com/library/7e4ae86f-4f64-4b3d-97b7-53ce2ac6c572)<br />**: IComparer -&gt; 'T -&gt; 'T -&gt; int**|Compare two values. May be called as a recursive case from an implementation of **T:System.IComparable&#96;1** to ensure consistent NaN comparison semantics.|
