...
|[`compareWith`](https://msdn.microsoft.com/library/39df9501-99de-4ed3-b1d6-3aab44135861)<br />**: ('T -&gt; 'T -&gt; int) -&gt; 'T [] -&gt; 'T [] -&gt; int**|Compares two arrays using the given comparison function, element by element.|
...
|[`contains`](https://msdn.microsoft.com/library/3fe49df1-e2c5-4a11-8210-100b2294e94f)<br />**: 'T -&gt; 'T [] -&gt; bool**|Evaluates to `true` if the given element is in the input array.|
...
|[`countBy`](https://msdn.microsoft.com/library/4c453049-7502-49c8-8cbb-f1f739d43a2a)<br />**: ('T -&gt; 'Key) -&gt; 'T [] -&gt; ('Key &#42; int) []**|Applies a key-generating function to each element of an array and returns am array yielding unique keys and their number of occurrences in the original array.|
