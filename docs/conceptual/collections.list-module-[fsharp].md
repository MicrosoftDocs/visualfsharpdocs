...
|[chunkBySize](https://msdn.microsoft.com/library/77185011-d6ec-48fe-9a2e-3d42d615530c)<br />**: int -&gt; 'T list -&gt; 'T list list**|Divides the input list into chunks of size at most `chunkSize`.|
