...
>[!NOTE] {You can use **try...with** in asynchronous workflows and other computation expressions, in which case a customized version of the **try...with** expression is used. For more information, see [Asynchronous Workflows &#40;F&#35;&#41;](Asynchronous+Workflows+%28FSharp%29.md), and [Computation Expressions &#40;F&#35;&#41;](Computation+Expressions+%28FSharp%29.md).
