...
|[Float32WithMeasure](http://msdn.microsoft.com/en-us/library/cbedfd6d-5490-437e-a01c-815fada8666f)<br />**: float -&gt; float&lt;'u&gt;**|Creates a **float32** value with units-of-measure.|
