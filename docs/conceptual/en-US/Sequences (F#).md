...
[!CODE [FsLangRef1#1502](../CodeSnippet/VS_Snippets_Fsharp/fslangref1/FSharp/fs/sequences.fs#1502)]
...
[!CODE [FsLangRef1#1503](../CodeSnippet/VS_Snippets_Fsharp/fslangref1/FSharp/fs/sequences.fs#1503)]
    You can use the **-&gt;** operator instead of **yield**, in which case you can omit the **do** keyword, as shown in the following example.

[!CODE [FsLangRef1#1504](../CodeSnippet/VS_Snippets_Fsharp/fslangref1/FSharp/fs/sequences.fs#1504)]
    The following code generates a list of coordinate pairs along with an index into an array that represents the grid.

[!CODE [FsLangRef1#1505](../CodeSnippet/VS_Snippets_Fsharp/fslangref1/FSharp/fs/sequences.fs#1505)]
...
[!CODE [FsLangRef1#1506](../CodeSnippet/VS_Snippets_Fsharp/fslangref1/FSharp/fs/sequences.fs#1506)]
...
[!CODE [FsLangRef1#1507](../CodeSnippet/VS_Snippets_Fsharp/fslangref1/FSharp/fs/sequences.fs#1507)]
...
[!CODE [FsLangRef1#1508](../CodeSnippet/VS_Snippets_Fsharp/fslangref1/FSharp/fs/sequences.fs#1508)]
...
[!CODE [FsLangRef1#1509](../CodeSnippet/VS_Snippets_Fsharp/fslangref1/FSharp/fs/sequences.fs#1509)]
...
[!CODE [FsSequences#9](../CodeSnippet/VS_Snippets_Fsharp/fssequences/FSharp/fs/program.fs#9)]
...
0 10 20 30 40
```
By using [Seq.ofArray](http://msdn.microsoft.com/en-us/library/299cd4d9-be72-4511-aac8-089e1ddaac99) and [Seq.ofList&#60;'T&#62; Function &#40;F&#35;&#41;](Seq.ofList%3C%27T%3E+Function+28%F%2329%.md), you can create sequences from arrays and lists. However, you can also convert arrays and lists to sequences by using a cast operator. Both techniques are shown in the following code.

[!CODE [FsSequences#11](../CodeSnippet/VS_Snippets_Fsharp/fssequences/FSharp/fs/program.fs#11)]
...
[!CODE [FsSequences#14](../CodeSnippet/VS_Snippets_Fsharp/fssequences/FSharp/fs/program.fs#14)]
...
[!CODE [FsSequences#15](../CodeSnippet/VS_Snippets_Fsharp/fssequences/FSharp/fs/program.fs#15)]
...
[!CODE [FsSequences#17](../CodeSnippet/VS_Snippets_Fsharp/fssequences/FSharp/fs/program.fs#17)]
    The output is as follows.
...
[!CODE [FsSequences#201](../CodeSnippet/VS_Snippets_Fsharp/fssequences/FSharp/fs/program.fs#201)]
    The output is as follows.
...
[!CODE [FsSequences#202](../CodeSnippet/VS_Snippets_Fsharp/fssequences/FSharp/fs/program.fs#202)]
    The output is as follows.
