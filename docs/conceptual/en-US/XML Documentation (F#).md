...
For more information about how to generate documentation from XML, see [XML Documentation Comments &#40;C&#35; Programming Guide&#41;](XML+Documentation+Comments+28%C%23+Programming+Guide29%.md).
...
### Code
[!CODE [FsLangRef2#7101](FsLangRef2#7101)]
...
### Code
[!CODE [FsLangRef2#7102](FsLangRef2#7102)]
