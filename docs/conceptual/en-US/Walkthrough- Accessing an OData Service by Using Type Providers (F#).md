...
<br />
  ...
  For more information, see [LINQ Considerations &#40;WCF Data Services&#41;](LINQ+Considerations+28%WCF+Data+Services29%.md).
...
```
  The operators **?&gt;** and **?&lt;** are nullable operators. You can use a full set of nullable equality and comparison operators. For more information, see [Linq.NullableOperators Module &#40;F&#35;&#41;](Linq.NullableOperators+Module+28%F%2329%.md).
<br />
...
[LINQ Considerations &#40;WCF Data Services&#41;](LINQ+Considerations+28%WCF+Data+Services29%.md)

[ODataService Type Provider &#40;F&#35;&#41;](ODataService+Type+Provider+28%F%2329%.md)
