...
When indentation is required, you must use spaces, not tabs. At least one space is required. Your organization can create coding standards to specify the number of spaces to use for indentation; three or four spaces of indentation at each level where indentation occurs is typical. You can configure [!INCLUDE[vsprvs](../Token/vsprvs_md.md)] to match your organization's indentation standards by changing the options in the **Options**dialog box, which is available from the **Tools** menu. In the **Text Editor**node, expand **F#** and then click **Tabs**. For a description of the available options, see [Options, Text Editor, All Languages, Tabs](Options%2C+Text+Editor%2C+All+Languages%2C+Tabs.md).
...
[!CODE [FsCodeFormatting#1](../CodeSnippet/VS_Snippets_Fsharp/fscodeformatting/FSharp/fs/codeformatting.fs#1)]
...
[!CODE [FsCodeFormatting#2](../CodeSnippet/VS_Snippets_Fsharp/fscodeformatting/FSharp/fs/codeformatting.fs#2)]
...
[!CODE [FsCodeFormatting#3](../CodeSnippet/VS_Snippets_Fsharp/fscodeformatting/FSharp/fs/program1.fs#3)]
    [!CODE [FsCodeFormatting#4](../CodeSnippet/VS_Snippets_Fsharp/fscodeformatting/FSharp/fs/program2.fs#4)]
...
[!CODE [FsCodeFormatting#5](../CodeSnippet/VS_Snippets_Fsharp/fscodeformatting/FSharp/fs/codeformatting.fs#5)]
...
[!CODE [FsCodeFormatting#6](../CodeSnippet/VS_Snippets_Fsharp/fscodeformatting/FSharp/fs/codeformatting.fs#6)]
    [!CODE [FsCodeFormatting#7](../CodeSnippet/VS_Snippets_Fsharp/fscodeformatting/FSharp/fs/codeformatting.fs#7)]
...
[!CODE [FsCodeFormatting#8](../CodeSnippet/VS_Snippets_Fsharp/fscodeformatting/FSharp/fs/codeformatting.fs#8)]
...
[!CODE [FsCodeFormatting#9](../CodeSnippet/VS_Snippets_Fsharp/fscodeformatting/FSharp/fs/codeformatting.fs#9)]
...
<br />[!CODE [FsCodeFormatting#10](../CodeSnippet/VS_Snippets_Fsharp/fscodeformatting/FSharp/fs/codeformatting.fs#10)]
...
<br />[!CODE [FsCodeFormatting#13](../CodeSnippet/VS_Snippets_Fsharp/fscodeformatting/FSharp/fs/codeformatting.fs#13)]
