...
|[contains](https://msdn.microsoft.com/library/d17b835a-d48f-49a7-a2df-da02ba1c48b4)<br />**: 'T -&gt; seq&lt;'T&gt; -&gt; bool**|Evaluates to `true` if the given element is in the input sequence.|
...
|[tail](https://msdn.microsoft.com/library/1111ea81-e81d-4540-a7c0-465c892e8a23)<br />**: seq&lt;'T&gt; -&gt; seq&lt;'T&gt;**|Returns a new sequence by taking the input sequence without its first element.|
