...
|[contains](seq.contains['t]-function-[fsharp].md)<br />**: 'T -&gt; seq&lt;'T&gt; -&gt; bool**|Evaluates to `true` if the given element is in the input sequence.|
...
|[tail](seq.tail['t]-function-[fsharp].md)<br />**: seq&lt;'T&gt; -&gt; seq&lt;'T&gt;**|Returns a new sequence by taking the input sequence without its first element.|
