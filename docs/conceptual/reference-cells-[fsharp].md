...
|-------------------------------------------|-------------------------------------------------|---------------------------------------------|----------------------------------------------------|
| <strong>!</strong> (dereference operator) |          Returns the underlying value.          |      <strong>'a ref -&gt; 'a</strong>       |      <strong>let (!) r = r.contents</strong>       |
| <strong>:=</strong> (assignment operator) |          Changes the underlying value.          | <strong>'a ref -&gt; 'a -&gt; unit</strong> | <strong>let (:=) r x = r.contents &lt;- x</strong> |
|      <strong>ref</strong> (operator)      | Encapsulates a value into a new reference cell. |      <strong>'a -&gt; 'a ref</strong>       |   <strong>let ref x = { contents = x }</strong>    |
|     <strong>Value</strong> (property)     |       Gets or sets the underlying value.        |       <strong>unit -&gt; 'a</strong>        |    <strong>member x.Value = x.contents</strong>    |
| <strong>contents</strong> (record field)  |       Gets or sets the underlying value.        |             <strong>'a</strong>             |   <strong>let ref x = { contents = x }</strong>    |
